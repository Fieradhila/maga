          ...
          <ul class="treeview-menu">
            ...
            <li>
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="dftr_fasilitas.php"><i class="fa fa-circle-o"></i> Daftar Fasilitas</a></li>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box-body table-responsive no-padding">
                        <form action="proses_tambah_fasilitas.php" method="post" enctype="multipart/form-data">
                          <div class="modal-body">
                            <div class="form-group">
                              <label class="control-label" for="nama_seragam">Nama Fasilitas</label>
                              <input type="text" name="nama_seragam" autocomplete="off" class="form-control" id="nama_seragam">
                            </div>
                          </div>
                          <div class="modal-footer">
                            <button type="submit" class="btn btn-success btn-sm" value="Simpan">Tambah</button>
                          </div>
                        </form>
                        <hr>
                ...
                <td width="5%"><?php echo $i ?></td>
                  <td><?php echo $abc['nama_seragam']; ?></td>
                  <td width="5%"><a href=hapus_fasilitas.php?id_seragam=<?php echo $abc['id_seragam'];?> onclick="return confirm('Hapus Fasilitas?')"><button type="button" class="btn btn-block btn-primary btn-sm"><i class="fa fa-trash"></i> Hapus</button></a></td>
                </tr>
                <?php } ?>
                  </table>
              </div>
