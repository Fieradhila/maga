      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <tr>
            ...
            <td>&nbsp;&nbsp;</td>
            <td>
            <button type="submit" data-toggle="modal" data-target="#impor" value="impor" class="btn btn-block btn-primary btn-sm"><i class="fa fa-user-plus"> Impor</i></button></a>
            </td>
            <td>&nbsp;&nbsp;</td>
            <td>
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="../laporan/data_krywn_pdf.php">PDF (.pdf)</a></li>
              </ul>
              </div>
            </td>
            <td>&ensp;</td>
            ...
            <td>&nbsp;</td>
            <td>
              <input type=date class="form-control" name="tgl_masuk1" value="2023-02-01" id="tgl_masuk1">
            </td>
            <td>&nbsp;</td><?php
            $month = date('m');
            $day = date('d');
            ...
            ?>
            <td>
              <label for="tgl_masuk2">Sampai Tgl : </label>
            </td>
            <td>&nbsp;</td>
            <td>
            
              <input type="date" class="form-control" name="tgl_masuk2" value="<?= $today; ?>" id="tgl_masuk2">
            </td>
            <td>&nbsp;</td>
            <td><input type="submit" class="btn btn-block btn-primary btn-sm" value="Tampilkan"></td>
          </form>
          </tr>
          </table>
          ...
          <div class="col-xs-12">
                ...
                if(isset($_GET['cari'])){
                  $cari = $_GET['cari'];
                  $search = mysqli_query($sambung, "SELECT * FROM dftr_krywn WHERE  nama_krywn like '%".$cari."%' OR 
                                                                                    ID like '%".$cari."%' OR
                                                                                    NIK like '%".$cari."%' OR
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Impor Data Karyawan</h4>
        </div>
        <form action="impor_karyawan.php" method="POST" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label class="control-label" for="filekrywn">File (.xls)</label>
              <input type="file" name="filekrywn" autocomplete="off" id="filekrywn" class="form-control" required>
            </div>
          </div>
                      ...
                      <form action="tambah_karyawan.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                          <div class="form-group">
                            ...
                            <input type="date" name="tgl_lahir" placeholder="yyyy-mm-dd" autocomplete="off" id="tgl_lahir" class="form-control" required>
                            <br>
