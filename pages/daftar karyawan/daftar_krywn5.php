      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <tr>
            ...
            <td>
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="../laporan/data_krywn_pdf5.php">PDF (.pdf)</a></li>
              </ul>
              </div>
            </td>
          ...
          <div class="col-xs-12">
                ...
                if(isset($_GET['cari'])){
                  $cari = $_GET['cari'];
                  $search = mysqli_query($sambung, "SELECT * FROM dftr_krywn WHERE cabang='MAGA 5' AND nama_krywn like '%".$cari."%' OR 
                                                                                    ID like '%".$cari."%' OR
                                                                                    NIK like '%".$cari."%' OR
                  ...
                  $search = mysqli_query($sambung, "SELECT * FROM dftr_krywn WHERE cabang='MAGA 5'");
                }
                      ...
                      <form action="tambah_karyawan.php" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                          <div class="form-group">
                            ...
                            <input type="text" name="ID"  value="KRYWN_MG5_" autocomplete="off" id="ID" class="form-control" required>
                            <br>
