      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <tr>
            ...
            <td>
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="../laporan/data_krywn_pdf2.php">PDF (.pdf)</a></li>
              </ul>
              </div>
            </td>
          ...
          <tr>
            <td>
              ...
              <select id="filter" name="$filter" class="form-control">
                ...
                <a href="#"><option value="MAGA 1">MAGA 1</option></a>
                <option value="MAGA 2">MAGA 2</option>
                <option value="MAGA 3">MAGA 3</option>
                <option value="MAGA 4">MAGA 4</option>
                <option value="MAGA 5">MAGA 5</option>
              </select>
            </td>-->
            <!--<?php
            $switch = 'MAGA 4';
            switch ($switch) {
              case 'MAGA 1':
                $case1 = mysqli_query($sambung,"SELECT * FROM dftr_krywn WHERE cabang='MAGA 1'");
                while($cas1=mysqli_fetch_array($case1)){
                echo $cas1['nama_krywn'];}
                break;
              case 'MAGA 2' :
                $case2 = mysqli_query($sambung,"SELECT * FROM dftr_krywn WHERE cabang='MAGA 2'");
                break;
              case 'MAGA 3' :
                  $case3 = mysqli_query($sambung,"SELECT * FROM dftr_krywn WHERE cabang='MAGA 3'");
                break;
              case 'MAGA 4' :
                  $case4 = mysqli_query($sambung,"SELECT * FROM dftr_krywn WHERE cabang='MAGA 4'");
                  while($cas4=mysqli_fetch_array($case4)){
                    echo $cas4['nama_krywn'];}
                break;
              case 'MAGA 5' :
                  $case5 = mysqli_query($sambung,"SELECT * FROM dftr_krywn WHERE cabang='MAGA 5'");
                break;
              default:
                $default = mysqli_query($sambung,"SELECT * FROM dftr_krywn");
                break;
            }
            ?>-->
            <td>&nbsp;&nbsp;</td>
          ...
          <div class="col-xs-12">
                ...
                if(isset($_GET['cari'])){
                  $cari = $_GET['cari'];
                  $search = mysqli_query($sambung, "SELECT * FROM dftr_krywn WHERE cabang='MAGA 2' AND nama_krywn like '%".$cari."%' OR 
                                                                                    ID like '%".$cari."%' OR
                                                                                    NIK like '%".$cari."%' OR
                  ...
                  $search = mysqli_query($sambung, "SELECT * FROM dftr_krywn WHERE cabang='MAGA 2'");
                }
                      ...
                      <form action="tambah_karyawan.php" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                          <div class="form-group">
                            ...
                            <input type="text" name="ID"  value="KRYWN_MG2_" autocomplete="off" id="ID" class="form-control" required>
                            <br>
