        ...
        <div class="box-header">
          ...
          <tr>
            ...
            <td>
              <div class="input-group">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">&emsp;<b>BULANAN</b>&nbsp;</a>
          ...
          <div class="col-xs-12">
                ...
                if(isset($_GET['tanggal'])){
                  $tgl1 = $_GET['tanggal'];
                  $cari_tgl = mysqli_query($sambung, "SELECT * FROM penilaian_krywn WHERE tgl_sakit like '%".$tgl1."%'");
                }elseif (isset($_GET['bulan'])) {
                  $bln1 = $_GET['bulan'];
                  $cari_tgl = mysqli_query($sambung, "SELECT * FROM penilaian_krywn WHERE tgl_sakit like '%".$bln1."%'");
