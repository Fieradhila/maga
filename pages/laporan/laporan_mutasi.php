...
<section class="content">
      <div class="box box-primary">
        <div class="box-header">
          <form action="proses_laporan_mutasi.php" method="post" enctype="multipart/form-data">
        <table border="0" align="left">
          <tr>
            <td>
              <button type="submit" value="simpan" class="btn btn-block btn-primary btn-sm"><i class="fa fa-user-plus"> Cetak</i></button></a>
            </td>
          </tr>
          </table>
</form>
          ...
          <div class="col-xs-12">
                ...
                <tr align="center" valign="middle">
                  ...
                  <td><b>Lokasi Lama</b></td>
                  <td><b>Lokasi Baru</b></td>
                  <td><b>Departement Lama</b></td>
                  <td><b>Departement Baru</b></td>
                  <td><b>Jabatan Lama</b></td>
                  <td><b>Jabatan Baru</b></td>
                  <td><b>Alasan</b></td>
                  <td><b>Aksi</b></td>
                </tr>
                <?php
                ...
                if(isset($_GET['cari'])){
                  $cari = $_GET['cari'];
                  $search = mysqli_query($sambung, "SELECT * FROM mutasi_krywn ORDER BY tgl_mutasi DESC where NIK like '%".$cari."%' OR 
                                                                                    nama_krywn like '%".$cari."%' OR
                                                                                    ID like '%".$cari."%'");
                }else{
                  $search = mysqli_query($sambung, "SELECT * FROM mutasi_krywn ORDER BY tgl_mutasi DESC");
                }
                ...
                <tr>
                  ...
                  <td><?php echo $d['lokasi_lama']; ?></td>
                  <td><?php echo $d['lokasi_baru']; ?></td>
                  <td><?php echo $d['departement_lama']; ?></td>
                  <td><?php echo $d['departement_baru']; ?></td>
                  <td><?php echo $d['jabatan_lama']; ?></td>
                  <td><?php echo $d['jabatan_baru']; ?></td>
                  <td><?php echo $d['alasan']; ?></td>
                  <td><a href=../laporan/surat_mutasi.php?kode_mutasi=<?php echo $d['kode_mutasi'];?>><button type="button" class="btn btn-block btn-primary btn-sm">Surat Mutasi</button></a></td>
                </tr>
                <?php } ?>
                  </table>
                  <br>
